...
(function () {
	...
	*/
	...
	(function () {
		...
		function q(a) {
			var c = new CKEDITOR.dom.element(a.$.form);
			c && ((a = c.$.elements.ckCsrfToken) ? a = new CKEDITOR.dom.element(a) : (a = new CKEDITOR.dom.element("input"), a.setAttributes({
				name: "ckCsrfToken",
				type: "hidden"
			}), c.append(a)), a.setAttribute("value", CKEDITOR.tools.getCsrfToken()))
		}
		...
		function l(a, c, d, b) {
			if (b && b.length)
				for (var e, g = b.length; g--;)
					if (e = b[g], "hbox" != e.type && "vbox" != e.type && "fieldset" !=
						e.type || l(a, c, d, e.children), e.filebrowser)
						if ("string" == typeof e.filebrowser && (e.filebrowser = {
							...
							f && (e.onClick = p, e.filebrowser.url = f, e.hidden = !1)
						} else if ("QuickUpload" == e.filebrowser.action && e["for"] && (f = e.filebrowser.url, void 0 === f && (f = a.config["filebrowser" + k(c) + "UploadUrl"],
				...
				e.onClick = function (b) {
					...
					if (r.call(c, b)) {
						if ("form" !== a.config.filebrowserUploadMethod && e) return b = a.uploadRepository.create(d.$.files[0]), b.on("uploaded", function (a) {
							...
							n.bind(this)), b.on("abort", n.bind(this)), b.loadAndUpload(f), "xhr";
						q(d);
						return !0
					}
					return !1
				...
				e.filebrowser.url = f;
				e.hidden = !1;
				t(a, d.getContents(e["for"][0]).get(e["for"][1]), e.filebrowser)
			}
		}

		function n(a) {
			this.enable();
			alert(a.sender.message)
		}
